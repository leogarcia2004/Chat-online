...
def main(pagina):
    ...
    campo_mensagem = ft.TextField(label="Digite sua mensagem aqui", on_submit=enviar_mensagem)
    ...
    popup = ft.AlertDialog(open=False, modal=True, title=ft.Text("Bem vindo ao Hashzap"), content=nome_usuario, actions=[ft.ElevatedButton("Entrar", on_click=entrar_chat)]) 
